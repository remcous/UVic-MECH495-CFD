function drivenCavity(psi_0,zeta_0,Re_i, Re_f, epsilon)
    ...
    for Re = Re_i:Re_f
        ...
        saveas(gcf,[pwd '\Figures\zeta\zeta_' num2str(Re) '.png']); close(gcf);
        ...
        saveas(gcf,[pwd '\Figures\psi\psi_' num2str(Re) '.png']); close(gcf);
        ...
        saveas(gcf,[pwd '\Figures\vector\vector_' num2str(Re) '.png']); close(gcf);
